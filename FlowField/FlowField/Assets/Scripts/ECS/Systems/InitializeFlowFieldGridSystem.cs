...
namespace TMG.ECSFlowField
{
	public class InitializeFlowFieldGridSystem : SystemBase
	{
		...
		protected override void OnUpdate()
		{
			...
			Entities.ForEach((Entity entity, ref NewFlowFieldData newFlowFieldData, ref FlowFieldData flowFieldData) =>
			{
				...
				DynamicBuffer<EntityBufferElement> buffer = newFlowFieldData.isExistingFlowField
					? EntityManager.GetBuffer<EntityBufferElement>(entity)
